...
#-- Se recorre la lista de forma RECURSIVA y 
...
#--------------------------------------------
#-- Impriimir la lista
#-- La lista se recorre de manera RECURSIVA
#-- ENTRADAS:
...
print_list:
	...
	#-- Si la lista No es Null procesarla
	bne a0, zero, print_list_recur
	
	#-- La lista es null: terminar
	ret
...
print_list_recur:
	...
	#-- Meter en a0 la direccion del siguiente nodo
	mv a0, t0
	lw a0, 0(a0)  #-- a0 = next
